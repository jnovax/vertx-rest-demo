...
import org.jnovax.vertx_demo.rest.utils.RedisUtils;
...
public class ApiVerticle extends AbstractVerticle {
    ...
    public void start(Promise<Void> promise) {
        final RedisConnection redisClient = RedisUtils.buildClient(vertx);

        final BookRepository bookRepository = new BookRepository();
        final BookService bookService = new BookService(redisClient, bookRepository);
